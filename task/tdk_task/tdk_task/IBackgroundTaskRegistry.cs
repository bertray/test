...
{
    public interface IBackgroundTaskRegistry: IDisposable
    {
        ...
        void AddListener(IBackgroundTaskRegistryListener listener);
        void RemoveListener(IBackgroundTaskRegistryListener listener);
        IList<IBackgroundTaskRegistryListener> GetListeners();
    }
}
